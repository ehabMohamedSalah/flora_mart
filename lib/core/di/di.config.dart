...
import '../../data/datasource_contract/address_datasource.dart' as _i44;
...
import '../../data/datasource_contract/change_password_datasource.dart'
    as _i457;
import '../../data/datasource_contract/edit_profile_datasource.dart' as _i949;
import '../../data/datasource_contract/filter_datasource.dart' as _i484;
...
import '../../data/datasource_contract/forget_password_datasource/verify_reset_code_datasource.dart'
    as _i574;
import '../../data/datasource_contract/get_all_notifications_datasource.dart'
    as _i335;
...
import '../../data/datasource_contract/occasion_datasource/occasions_datasource.dart'
    as _i331;
import '../../data/datasource_contract/order_datasource_contract.dart' as _i519;
import '../../data/datasource_contract/payment_process_datasource/payment_process_datasource.dart'
    as _i441;
...
import '../../data/datasource_contract/tracked_order_datasource/tracked_order_datasource.dart'
    as _i460;
import '../../data/datasource_impl/address_datasource_impl.dart' as _i283;
...
import '../../data/datasource_impl/change_password_datasource_impl.dart'
    as _i1054;
import '../../data/datasource_impl/edit_profile_datasource_impl.dart' as _i757;
import '../../data/datasource_impl/filter_datasource_impl.dart' as _i540;
...
import '../../data/datasource_impl/forget_password_datasource_impl/verify_reset_code_datasource_impl.dart'
    as _i353;
import '../../data/datasource_impl/get_all_notifications_datasource_impl.dart'
    as _i289;
...
import '../../data/datasource_impl/occasions_datasource_impl/occassions_datasource_impl.dart'
    as _i626;
import '../../data/datasource_impl/order_datasource_impl.dart' as _i648;
import '../../data/datasource_impl/Payment_process_datasource_impl/payment_process_datasource_impl.dart'
    as _i24;
...
import '../../data/datasource_impl/tracked_order_datasource_impl/tracked_order_datasource_impl.dart'
    as _i339;
import '../../data/repo_impl/address_repo_impl.dart' as _i302;
...
import '../../data/repo_impl/edit_profile_repo_impl.dart' as _i216;
import '../../data/repo_impl/filter_repo_impl.dart' as _i522;
...
import '../../data/repo_impl/forget_password_repo_impl/verify_reset_code_repo_impl.dart'
    as _i721;
import '../../data/repo_impl/get_all_notifications_repo_impl.dart' as _i47;
...
import '../../data/repo_impl/order_repo_impl.dart' as _i774;
import '../../data/repo_impl/Payment_process_repo_impl/payment_process_repo_impl.dart'
    as _i418;
...
import '../../data/repo_impl/tracked_order_repo_impl/tracked_order_repo_impl.dart'
    as _i203;
import '../../domain/repo_contract/address_repo.dart' as _i51;
...
import '../../domain/repo_contract/change_password_repo.dart' as _i222;
import '../../domain/repo_contract/edit_profile_repo.dart' as _i808;
import '../../domain/repo_contract/filter_repo.dart' as _i150;
...
import '../../domain/repo_contract/forget_password_repo_contract/verify_reset_code_repo.dart'
    as _i544;
import '../../domain/repo_contract/get_all_notifications_repo.dart' as _i815;
...
import '../../domain/repo_contract/order_repo.dart' as _i455;
import '../../domain/repo_contract/Payment_process_repo/payment_process_repo.dart'
    as _i265;
...
import '../../domain/repo_contract/tracked_order_repo/tracked_order_repo.dart'
    as _i294;
import '../../domain/usecase/add_address_usecase.dart' as _i201;
...
import '../../domain/usecase/change_password_usecase.dart' as _i790;
import '../../domain/usecase/changeGuest_usecase.dart' as _i285;
import '../../domain/usecase/check_guest_usecase.dart' as _i304;
import '../../domain/usecase/edit_profile_usecase.dart' as _i327;
import '../../domain/usecase/filter_usecase.dart' as _i14;
...
import '../../domain/usecase/forget_password_usecases/verify_reset_code_usecase.dart'
    as _i323;
import '../../domain/usecase/get_all_notifications_usecase.dart' as _i864;
...
import '../../domain/usecase/order_usecase.dart' as _i906;
import '../../domain/usecase/Payment_process_uesecases/cash_usecase.dart'
    as _i879;
import '../../domain/usecase/Payment_process_uesecases/credit_card_usecase.dart'
    as _i364;
...
import '../../domain/usecase/tracked_order_usecase/create_tracked_order_usecase.dart'
    as _i96;
import '../../domain/usecase/tracked_order_usecase/get_route_usecase.dart'
    as _i1011;
import '../../domain/usecase/tracked_order_usecase/get_tracked_order_usecase.dart'
    as _i866;
import '../../domain/usecase/update_address_usecase.dart' as _i60;
import '../../domain/usecase/upload_photo_usecase.dart' as _i28;
import '../../presentation/address/view_model/address_cubit.dart' as _i202;
...
import '../../presentation/edit_profile_screen/view_model/edit_profile_cubit.dart'
    as _i678;
import '../../presentation/notification_screen/view_model/notification_cubit.dart'
    as _i478;
import '../../presentation/order_map_screen/view_model.dart/cubit/order_map_cubit.dart'
    as _i1016;
import '../../presentation/orders/view_model/order_cubit.dart' as _i238;
...
import '../../presentation/tabs/profile_tab/view_model/main_profile_cubit.dart'
    as _i238;
import '../../presentation/track_order_screeen/view_model/cubit/track_order_cubit.dart'
    as _i640;
import '../api/api_manager.dart' as _i1047;
import '../cache/shared_pref.dart' as _i299;
import '../local/firestore_helper.dart' as _i17;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i17.FirestoreHelper>(() => _i17.FirestoreHelper());
    ...
    gh.factory<_i410.ResetPasswordDataSourceRepo>(
        () => _i992.ResetPasswordDataSourceRepoImpl(
              gh<_i299.CacheHelper>(),
              gh<_i1047.ApiManager>(),
            ));
    gh.factory<_i233.ResetPasswordRepo>(() =>
        _i1065.ResetPasswordRepoImpl(gh<_i410.ResetPasswordDataSourceRepo>()));
    gh.factory<_i460.TrackedOrderDatasource>(
        () => _i339.TrackedOrderDatasourceImpl(
              gh<_i17.FirestoreHelper>(),
              gh<_i1047.ApiManager>(),
            ));
    ...
    gh.factory<_i335.GetAllNotificationsDatasource>(
        () => _i289.GetAllNotificationsDatasourceImpl(
              gh<_i1047.ApiManager>(),
              gh<_i299.CacheHelper>(),
            ));
    ...
    gh.factory<_i441.PaymentProcessDataSource>(
        () => _i24.PaymentProcessDataSourceImpl(
              gh<_i1047.ApiManager>(),
              gh<_i299.CacheHelper>(),
            ));
    gh.factory<_i242.SearchDatasource>(
    ...
    gh.factory<_i457.ChangePasswordDatasource>(
        () => _i1054.ChangePasswordDatasourceImpl(
              gh<_i1047.ApiManager>(),
              gh<_i299.CacheHelper>(),
            ));
    ...
    gh.factory<_i44.AddressDataSource>(() => _i283.AddressDataSourceImpl(
          gh<_i1047.ApiManager>(),
          gh<_i299.CacheHelper>(),
        ));
    gh.factory<_i519.OrderDatasourceContract>(() => _i648.OrderDataSourceImpl(
          gh<_i1047.ApiManager>(),
          gh<_i299.CacheHelper>(),
        ));
    ...
    gh.factory<_i404.SearchRepo>(
        () => _i1008.SearchRepoImpl(gh<_i242.SearchDatasource>()));
    ...
    gh.factory<_i840.SearchUsecase>(
        () => _i840.SearchUsecase(gh<_i404.SearchRepo>()));
    gh.factory<_i784.GetAllProductsUsecase>(
        () => _i784.GetAllProductsUsecase(gh<_i697.GetAllProductsRepo>()));
    gh.factory<_i222.ChangePasswordRepo>(() =>
        _i836.ChangePasswordRepoImpl(gh<_i457.ChangePasswordDatasource>()));
    gh.factory<_i265.PaymentProcessRepo>(() =>
        _i418.PaymentProcessRepoImpl(gh<_i441.PaymentProcessDataSource>()));
    gh.factory<_i294.TrackedOrderRepo>(
        () => _i203.TrackedOrderRepoImpl(gh<_i460.TrackedOrderDatasource>()));
    gh.factory<_i51.AddressRepository>(
        () => _i302.AddressRepositoryImpl(gh<_i44.AddressDataSource>()));
    gh.factory<_i768.ResetPasswordUsecase>(() => _i768.ResetPasswordUsecase(
        resetPasswordRepo: gh<_i233.ResetPasswordRepo>()));
    gh.factory<_i808.EditProfileRepo>(
        () => _i216.EditProfileRepoImpl(gh<_i949.EditProfileDatasource>()));
    gh.factory<_i790.ChangePasswordUsecase>(
        () => _i790.ChangePasswordUsecase(gh<_i222.ChangePasswordRepo>()));
    ...
    gh.factory<_i96.CreateTrackedOrderUsecase>(
        () => _i96.CreateTrackedOrderUsecase(gh<_i294.TrackedOrderRepo>()));
    gh.factory<_i866.GetTrackedOrderUsecase>(
        () => _i866.GetTrackedOrderUsecase(gh<_i294.TrackedOrderRepo>()));
    gh.factory<_i1011.GetRouteUsecase>(
        () => _i1011.GetRouteUsecase(gh<_i294.TrackedOrderRepo>()));
    ...
    gh.factory<_i455.OrderRepo>(
        () => _i774.OrderRepoIml(gh<_i519.OrderDatasourceContract>()));
    gh.factory<_i64.BestSellerRepo>(
        () => _i133.BestSellerRepoImpl(gh<_i575.BestSellerDataSource>()));
    gh.factory<_i526.ChangePasswordCubit>(
        () => _i526.ChangePasswordCubit(gh<_i790.ChangePasswordUsecase>()));
    gh.factory<_i896.OccassionsUsecase>(
        () => _i896.OccassionsUsecase(gh<_i130.OccasionsRepo>()));
    gh.factory<_i815.GetAllNotificationsRepo>(() =>
        _i47.GetAllNotificationsRepoImpl(
            gh<_i335.GetAllNotificationsDatasource>()));
    gh.factory<_i906.OrderUsecase>(
        () => _i906.OrderUsecase(gh<_i455.OrderRepo>()));
    ...
    gh.factory<_i833.ResetPasswordCubit>(
        () => _i833.ResetPasswordCubit(gh<_i768.ResetPasswordUsecase>()));
    gh.factory<_i1016.OrdermapCubit>(
        () => _i1016.OrdermapCubit(gh<_i1011.GetRouteUsecase>()));
    gh.factory<_i150.FilterRepo>(
        () => _i522.FilterRepoImpl(gh<_i484.FilterDatasource>()));
    ...
    gh.factory<_i201.AddAddressUseCase>(
        () => _i201.AddAddressUseCase(gh<_i51.AddressRepository>()));
    ...
    gh.factory<_i640.TrackOrderCubit>(() => _i640.TrackOrderCubit(
          gh<_i866.GetTrackedOrderUsecase>(),
          gh<_i96.CreateTrackedOrderUsecase>(),
        ));
    gh.factory<_i864.GetAllNotificationsUsecase>(() =>
        _i864.GetAllNotificationsUsecase(gh<_i815.GetAllNotificationsRepo>()));
    gh.factory<_i238.OrderCubit>(
        () => _i238.OrderCubit(gh<_i906.OrderUsecase>()));
    gh.factory<_i1036.CategoriesUsecase>(
        () => _i1036.CategoriesUsecase(gh<_i41.CategoriesRepo>()));
    gh.factory<_i60.UpdateAddressUseCase>(
        () => _i60.UpdateAddressUseCase(gh<_i51.AddressRepository>()));
    gh.factory<_i327.EditProfileUsecase>(
        () => _i327.EditProfileUsecase(gh<_i808.EditProfileRepo>()));
    gh.factory<_i28.UploadPhotoUsecase>(
        () => _i28.UploadPhotoUsecase(gh<_i808.EditProfileRepo>()));
    gh.factory<_i383.ResetpasswordUsecase>(
        () => _i383.ResetpasswordUsecase(repo: gh<_i161.ResetpasswordRepo>()));
    gh.factory<_i678.EditProfileCubit>(() => _i678.EditProfileCubit(
          gh<_i327.EditProfileUsecase>(),
          gh<_i28.UploadPhotoUsecase>(),
        ));
    ...
    gh.factory<_i478.NotificationCubit>(
        () => _i478.NotificationCubit(gh<_i864.GetAllNotificationsUsecase>()));
    ...
    gh.factory<_i202.AddressCubit>(() => _i202.AddressCubit(
          gh<_i60.UpdateAddressUseCase>(),
          gh<_i201.AddAddressUseCase>(),
        ));
