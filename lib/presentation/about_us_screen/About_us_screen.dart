...
class AboutUsScreen extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> loadAboutUsJson() async {
    final String jsonString = await rootBundle.loadString(
        'assets/articles/Flowery About Section JSON with Expanded Content.json');
                ...
                child: FutureBuilder<Map<String, dynamic>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      final aboutAppSections =
                          snapshot.data?['about_app'] as List<dynamic>;

                      return ListView.builder(
                        itemCount: aboutAppSections.length,
                        itemBuilder: (context, index) {
                          final section = aboutAppSections[index];
